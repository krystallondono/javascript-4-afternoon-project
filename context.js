...
let user = {
  username: 'xxvampirebunniezxx',
  email: 'the8thcullen@aol.com',
...
let animal1 = new Animal('bunnicula', 'rabbit', 'vegetables');
...
let context3 = vacation.whatIsThis.apply(vacation);
